...
4. Name it "puma-arc-solver-v2"
5. Make it public
6. Add dataset to your submission notebook

The v2 archive ships with the full `arc_solver` package plus pre-trained assets (`guidance_model.json`, episodic memories, continuity checkpoints) so the new failure logging and replay hooks work out of the box on Kaggle.
